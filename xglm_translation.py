...
from functions import initialize_logs, import_data, XGLM_Translator, evaluate_model
...
if __name__ == "__main__":
    try: 
        ...
        output_dir_name = f"xglm_{src_col}_{tgt_col}_{timestamp}"
