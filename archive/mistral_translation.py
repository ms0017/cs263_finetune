...
from functions import initialize_logs, import_data, Mistral_Translator, evaluate_model
...
if __name__ == "__main__":
    try: 
        ...
        output_dir_name = f"mistral_{src_col}_{tgt_col}_{timestamp}"
        ...
        evaluate_model(translator, dataset, src_col, tgt_col, logger, subset=100)
